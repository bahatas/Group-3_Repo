...
/**
 * We have a fox group consists of 4 foxes.  one of them stole an egg from chicken barn.
...
public class ThiefFox {
    ...
    public static void main(String[] args) {
        ...
        // method creating inside of  class because we are repeating somethings // if else
        // we can create more methods finding suspect
        // create a method for setting these info
